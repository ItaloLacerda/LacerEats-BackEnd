...
public class ProductGroupsController implements CommonController<ProductGroupsResponseDTO, ProductGroupsDTO> {
    ...
    public ResponseEntity<List<ProductGroupsResponseDTO>> searchAll(){
        return new ResponseEntity<List<ProductGroupsResponseDTO>>(productGroupService.searchAll(), HttpStatus.OK);
    }

    @PostMapping
    public ResponseEntity<ProductGroupsResponseDTO> register(@RequestBody @Valid ProductGroupsDTO ProductGroup) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ProductGroupsResponseDTO> update(@PathVariable Integer id, @RequestBody @Valid ProductGroupsDTO productGroup) {
